  ...
  return (
    <div className="flex flex-col w-full gap-3">
        <div>
            ...
            <p className='text-[12px]'> Select the type of event you're trying to register.</p>
        </div>
        <div
        ...
        >
            <TypeCard
                ...
                description={"Events where everyone will compete independant of eachother; each partner's scores are then combined or averaged to determine a winner."}
        ...
        >
            <TypeCard
                ...
                description={'Events where teams will compete against eachother directly. These competitions can be by points or win/loss.'}
        ...
        >
            <TypeCard
                e_type='Team Event'
                description={'Events where both partners will work towards a combined goal and the team only has 1 score.'}
